...
@Component({
  ...
  template: `
    <div class="p-6.5">
      ...
      <div *ngIf="!isLoading && receipt" class="flex flex-col gap-6">
        <!-- Barra de Acciones Interna (Solo visible en la vista previa, no en impresión) -->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <!-- Recibo: NOTA DE PAGO -->
          <div class="bg-white border-2 border-gray-300 p-6 print-container">
